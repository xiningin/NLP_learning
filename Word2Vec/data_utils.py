...
class StanfordSentiment:
    ...
    def sent_labels(self):
        ...
        for i in range(self.numSentences()):
            ...
            sent_labels[i] = labels[dictionary[full_sent]] # 索引是phraseId，值是分类得分
    ...
    def getRandomTrainSentence(self):
        ...
        sentId = split[0][random.randint(0, len(split[0]) - 1)] # 取train集随机一句
    ...
    def sampleTable(self):
        ...
        for i in range(self.tablesize):
            while i > samplingFreq[j]: # 加到比sampleFreq大的第一个位置，正好落入区间
                j += 1
